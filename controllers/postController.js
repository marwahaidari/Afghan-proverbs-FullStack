...
const posts = require('../data/posts'); // یا هرجایی که داده‌هات هستن
...
exports.searchPost = (req, res) => {
  ...
  const results = posts.filter(post => post.id.toString() === query);

  res.render('index', { posts: results, showBack: true });
};
